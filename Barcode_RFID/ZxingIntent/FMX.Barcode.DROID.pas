...
uses
  ...
  System.Messaging, FMX.Helpers.Android, Androidapi.Helpers,
  Androidapi.JNIBridge, Androidapi.JNI.JavaTypes,
  Androidapi.JNI.GraphicsContentViewText, Androidapi.JNI.App,
  Androidapi.JNI.Net, Androidapi.JNI.Toast;

const
  ScanRequestCode: Integer = 0;
...
begin
  if M is TMessageResultNotification then
    DoActivityResult(TMessageResultNotification(M).RequestCode,
...
begin
  ResolveInfo := TAndroidHelper.Activity.getPackageManager.resolveActivity
    (Intent, 0);
