...
{$METHODINFO ON}
  TServerMethods1 = class(TDataModule)
    ...
    CaseTableEngineeringReqNumber__c: TWideStringField;
    CaseTableSLAViolation__c: TWideStringField;
    CaseTableProduct__c: TWideStringField;
    CaseTablePotentialLiability__c: TWideStringField;
  private
