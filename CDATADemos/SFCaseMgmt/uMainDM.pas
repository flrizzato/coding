...
type
  TMainDM = class(TDataModule)
    ...
    CaseMemTableEngineeringReqNumber__c: TWideStringField;
    CaseMemTableSLAViolation__c: TWideStringField;
    CaseMemTableProduct__c: TWideStringField;
    CaseMemTablePotentialLiability__c: TWideStringField;
